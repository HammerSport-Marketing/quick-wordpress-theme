                            ...
                            <div class="client-group col">
                                <div class="row">
                                    <div class="client col-3 py-3">
                                        <img alt="Image placeholder" src="<?php echo get_theme_file_uri('/src/assets/img/clients/svg/google-gray.svg');?>">
                                    </div>
                                    <div class="client col-3 py-3">
                                        <img alt="Image placeholder" src="<?php echo get_theme_file_uri('/src/assets/img/clients/svg/spotify-gray.svg');?>">
                                    </div>
                                    <div class="client col-3 py-3">
                                        <img alt="Image placeholder" src="<?php echo get_theme_file_uri('/src/assets/img/clients/svg/airbnb-gray.svg');?>">
                                    </div>
                                    <div class="client col-3 py-3">
                                        <img alt="Image placeholder" src="<?php echo get_theme_file_uri('/src/assets/img/clients/svg/paypal-gray.svg');?>">
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 mb-5 mb-lg-0">
                    <div data-animate-hover="2">
                        <div class="animate-this">
                            <a href="#">
                                <img alt="Image placeholder" class="img-fluid rounded shadow" src="<?php echo get_theme_file_uri('/src/assets/img/theme/light/person-1.jpg');?>">
                            </a>
                        </div>
                        <div class="mt-3">
                ...
                <div class="col-lg-3 col-sm-6 mb-5 mb-lg-0">
                    <div data-animate-hover="2">
                        <div class="animate-this">
                            <a href="#">
                                <img alt="Image placeholder" class="img-fluid rounded shadow" src="<?php echo get_theme_file_uri('/src/assets/img/theme/light/person-2.jpg');?>">
                            </a>
                        </div>
                        <div class="mt-3">
                ...
                <div class="col-lg-3 col-sm-6 mb-5 mb-lg-0">
                    <div data-animate-hover="2">
                        <div class="animate-this">
                            <a href="#">
                                <img alt="Image placeholder" class="img-fluid rounded shadow" src="<?php echo get_theme_file_uri('/src/assets/img/theme/light/person-3.jpg');?>">
                            </a>
                        </div>
                        <div class="mt-3">
                ...
                <div class="col-lg-3 col-sm-6 mb-5 mb-lg-0">
                    <div data-animate-hover="2">
                        <div class="animate-this">
                            <a href="#">
                                <img alt="Image placeholder" class="img-fluid rounded shadow" src="<?php echo get_theme_file_uri('/src/assets/img/theme/light/person-4.jpg');?>">
                            </a>
                        </div>
                        <div class="mt-3">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-6">
                    ...
                    <form id="form-contact">
                        ...
                        <div class="form-group">
                            <textarea class="form-control form-control-lg" data-toggle="autosize" placeholder="Tell us a few words ..." rows="3" required></textarea>
                        </div>

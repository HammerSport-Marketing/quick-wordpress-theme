            ...
            <div class="row row-grid align-items-center">
                ...
                <div class="col-12 col-md-7 col-lg-6 order-md-1 pr-md-5">
                    ...
                    <h1 class="display-4 text-center text-md-left mb-3">
                        <?php the_sub_field('catch_phrase') ?> <strong class="text-primary">
                            <?php the_sub_field('focus_item') ?> </strong>
                    </h1>
                    <!-- Description Text -->
                    ...
                    <div class="text-center text-md-left mt-5">
                        ...
                        <a href="<?php the_sub_field('url') ?>"
                            class="btn btn-neutral btn-icon d-none d-lg-inline-block"><?php the_sub_field('label') ?></a>
                        <?php
                                                        endwhile;
                                                    else : ?>
                        <div> Please check your ACF config. Something went wrong!</div>
                ...
                <div class="col-md-4">
                    <div class="card border-0 bg-soft-danger">
                        <div class="card-body pb-5">
                            <div class="pt-4 pb-5">
                                <img src="<?php the_sub_field('image'); ?>" class="img-fluid img-center"
                    ...
                    <div class="col-md-10 text-center">
                        <div class="mt-4 mb-6">
                            ...
                            <?php if (have_rows('button')) :
                                        ...
                                        ?>
                            <a href="https://www.youtube.com/watch?v=zodT9bCdIiI" data-fancybox data-toggle="tooltip"
                                data-placement="bottom" title="Watch video in lightbox"
                                class="btn btn-warning btn-icon hover-translate-y-n10 mt-4">
                                <span class="btn-inner--icon">
                    ...
                    <div class="card card-pricing text-center px-3 shadow hover-scale-110">
                        ...
                        <div class="card-body">
                            ...
                            <a href="<?php the_sub_field('url') ?>"
                                ...
                                target="_blank"><?php the_sub_field('text') ?></a>
                            <?php
                                                            endwhile;
                                                        endif;
                                                        ?>
